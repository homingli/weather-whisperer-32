...
export const QUIET = {
  ...
  WIND_KMH: 20,
  /** AQHI at or below this value rests in the quiet shelf; only 5+ earns
   *  the full color-coded chip (HML-9). EPD's "Low" band is 1–3, but the
   *  moderate floor (4) is still routine air — not worth an alarm. */
  AQHI_MAX: 4,
} as const;
